<?php include('../include/top_header.php') ?>
			...
			$function_GetBankByID = GetBankByID($input_parameter);
			?>
				...
				<div class="contentpanel">
					...
					<div class="container clear_both padding_fix">
						...
						<form action="Process.php" method="post" class="form-horizontal row-border">
									...
									<div class="block-web">
										...
										<div class="porlets-content">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="textBank" value="<?php echo $function_GetBankByID['BANK'][0]; ?>">
												</div>
											</div>
							...
							<input type="hidden" name="module" value="BankDetail" />
						</form>
					</div>
					<!--\\\\\\\ container  end \\\\\\-->
				</div>
