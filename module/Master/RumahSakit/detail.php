											...
											<footer class="card-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<a href="process.php?module=DeleteRumahSakit&id=<?php echo $current_id ?>" class="btn btn-danger ">Hapus</a>
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namarumahsakit" name="textAlamat" value="<?php echo $function_GetRumahSakitByID['ADDRESS'][0]; ?>" required >
											</div>
										</div>
