			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namaslider" name="textAlt" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="file" class="form-control" id="input_namaslider" name="fileImage" required >
					...
					<!-- end: page -->
						...
						<input type="hidden" name="module" value="AddSlider" />
					</form>
				</section>
			</div>
