								...
								<section class="card">
									...
									<div class="card-body">
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												<?php
												$function_GetAllSlider = GetAllSlider();
												
												for( $i=0;$i<$function_GetAllSlider['TOTAL_ROW'];$i++ ){
													
													?>
													<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllSlider['ID'][$i] ;?>'">
														<td><?php echo ($i+1);?></td>
														<td><?php echo $function_GetAllSlider['IMAGE'][$i];?></td>
														<td><?php echo $function_GetAllSlider['ALT'][$i];?></td>
													</tr>
													<?php
