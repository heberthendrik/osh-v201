										...
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												...
												for( $i=0;$i<$function_GetAllPetugas['TOTAL_ROW'];$i++ ){
													...
													if( $function_GetAllPetugas['IS_ACTIVE'][$i] == 1 ){
													...
													if( $function_GetAllPetugas['ID'][$i] > 1 ){
														?>
														<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllPetugas['ID'][$i] ;?>'">
															<td><?php echo $function_GetAllPetugas['ID'][$i];?></td>
															<td><?php echo $function_GetAllPetugas['NAME'][$i];?></td>
															<td><?php echo $function_GetAllPetugas['NIK_EMPLOYEE'][$i];?></td>
