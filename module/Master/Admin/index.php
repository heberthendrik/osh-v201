								...
								<section class="card">
									...
									<div class="card-body">
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												<?php
												$function_GetAllAdmin = GetAllAdmin();
												
												for( $i=0;$i<$function_GetAllAdmin['TOTAL_ROW'];$i++ ){
												
													if( $function_GetAllAdmin['IS_ACTIVE'][$i] == 1 ){
													...
													$input_parameter_rs['ID'] = $function_GetAllAdmin['ID_RS'][$i];
													$function_GetRumahSakitByID = GetRumahSakitByID($input_parameter_rs);
													
													if( $function_GetAllAdmin['ID'][$i] > 1 ){
														?>
														<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllAdmin['ID'][$i] ;?>'">
															<td><?php echo $function_GetAllAdmin['ID'][$i];?></td>
															<td><?php echo $function_GetAllAdmin['NAME'][$i];?></td>
															<td><?php echo $function_GetAllAdmin['NIK_EMPLOYEE'][$i];?></td>
