			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											<label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Nama Admin *</label>
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namaadmin" name="textNama" required >
											</div>
										</div>
										<!--
										<div class="form-group row">
					...
					<!-- end: page -->
						...
						<input type="hidden" name="module" value="AddAdmin" />
					</form>
				</section>
			</div>
