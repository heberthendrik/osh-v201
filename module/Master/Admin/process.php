...
if( $_POST['module'] == "AddAdmin" ){
	...
	$function_result = AddAdmin($input_parameter);
...
if( $_POST['module'] == "UpdateAdmin" ){
	...
	$function_result = UpdateAdminByID($input_parameter);
...
if( $_GET['module'] == "DeleteAdmin" ){
	
	$input_parameter['ID'] = $_GET['id'];
	
	$function_result = DeleteAdminByID($input_parameter);
