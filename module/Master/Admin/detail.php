...
$current_id = $_GET['id'];
$admin_parameter['ID'] = $current_id;
$function_GetAdminByID = GetAdminByID($admin_parameter);
?>
<!doctype html>
				...
				<section role="main" class="content-body card-margin">
					<header class="page-header">
						<h2>
							Admin - 
							<?php
							if( $function_GetAdminByID['EMAIL'] ){
											...
											<footer class="card-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<a href="process.php?module=DeleteAdmin&id=<?php echo $current_id ?>" class="btn btn-danger ">Hapus</a>
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											<label class="col-lg-4 control-label text-lg-right pt-2" for="inputDefault">Nama Admin *</label>
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namaadmin" name="textNama" value="<?php echo rtrim($function_GetAdminByID['NAME'][0]);?>" required >
											</div>
										</div>
										
										<div class="form-group row">
											<label class="col-lg-4 control-label text-lg-right pt-2" for="inputDefault">ID Karyawan *</label>
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namaadmin" name="textNIKEmployee" value="<?php echo rtrim($function_GetAdminByID['NIK_EMPLOYEE'][0]);?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<select class="form-control " id="input_status" name="selectStatus" required >
													<option value="0" <?php if( $function_GetAdminByID['IS_ACTIVE'][0] == 0 ){ echo ' selected '; } ?> >Tidak Aktif</option>
													<option value="1" <?php if( $function_GetAdminByID['IS_ACTIVE'][0] == 1 ){ echo ' selected '; } ?> >Aktif</option>
												</select>
											</div>
										</div>
										
										<div class="form-group row">
											<label class="col-lg-4 control-label text-lg-right pt-2" for="inputDefault">Temp Password *</label>
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namaadmin" name="" value="<?php echo rtrim($function_GetAdminByID['TEMP_PASSWORD'][0]);?>" readonly >
											</div>
										</div>
												...
												<div class="col-lg-6">
													<select class="form-control " id="input_idrs" name="selectRumahSakit" required >
														...
														for( $i=0;$i<$function_GetAllRumahSakit['TOTAL_ROW'];$i++ ){
															...
															if( $function_GetAllRumahSakit['ID'][$i] == $function_GetAdminByID['ID_RS'][0] ){
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namaadmin" name="textNIK" value="<?php echo rtrim($function_GetAdminByID['NIK'][0]);?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namaadmin" name="textNoTelp" value="<?php echo rtrim($function_GetAdminByID['PHONE_NUMBER'][0]);?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namaadmin" name="emailEmail" value="<?php echo rtrim($function_GetAdminByID['EMAIL'][0]);?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<select class="form-control" id="input_status" name="selectSex" required >
													...
													<option value="L" <?php if( $function_GetAdminByID['SEX'][0] == "L" ){ echo ' selected '; } ?> >Laki-Laki</option>
													<option value="P" <?php if( $function_GetAdminByID['SEX'][0] == "P" ){ echo ' selected '; } ?> >Perempuan</option>
												</select>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="date" class="form-control" id="input_namapasien" name="dateTanggalLahir" required  value="<?php echo $function_GetAdminByID['BIRTH_DATE'][0]; ?>" >
											</div>
										</div>
					...
					<!-- end: page -->
						...
						<input type="hidden" name="module" value="UpdateAdmin" />
