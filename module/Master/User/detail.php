											...
											<footer class="card-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<a href="process.php?module=DeleteUser&id=<?php echo $current_id ?>" class="btn btn-danger ">Confirm</a>
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namauser" name="textNama" value="<?php echo $function_GetUserByID['NAMA'][0] ;?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="email" class="form-control" id="input_namauser" name="emailEmail" value="<?php echo $function_GetUserByID['EMAIL'][0] ;?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<select class="form-control mb-3" id="input_status" name="selectRole" required >
													...
													<option value="admin" <?php if( rtrim($function_GetUserByID['ROLES'][0]) == 'admin' ){ echo ' selected '; } ?> >Admin</option>
													<option value="user" <?php if( rtrim($function_GetUserByID['ROLES'][0]) == 'user' ){ echo ' selected '; } ?> >Doctor</option>
													<option value="officer" <?php if( rtrim($function_GetUserByID['ROLES'][0]) == 'officer' ){ echo ' selected '; } ?> >Officer</option>
												</select>
											</div>
										</div>
											...
											<div class="col-lg-6">
												<select class="form-control mb-3" id="input_idrs" name="selectRumahSakit" required >
													...
													for( $i=0;$i<$function_GetAllRumahSakit['TOTAL_ROW'];$i++ ){
														...
														if( $function_GetAllRumahSakit['ID'][$i] == $function_GetUserByID['ID_RS'][0] ){
