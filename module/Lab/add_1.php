			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Lab - Tahap 1: Pilih Data Pasien Lab</h2>
											...
											<tbody>
												...
												for( $i=0;$i<$function_GetAllPasien['TOTAL_ROW'];$i++ ){
													...
													<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllPasien['ID'][$i] ;?>'">
														<td><?php echo $function_GetAllPasien['ID'][$i];?></td>
														<td><?php echo $function_GetAllPasien['NAME'][$i];?></td>
														<td><?php echo $function_GetAllPasien['ADDRESS'][$i];?></td>
														<td><?php echo $function_GetAllPasien['NO_RM'][$i];?></td>
														<td><?php echo $function_GetRumahSakitByID['NAMA'][0];?></td>
														<td> <a href="process.php?module=InputLabTahap1&id=<?php echo $_GET['id'];?>&pid=<?php echo $function_GetAllPasien['ID'][$i];?>" class="btn btn-danger" style="color:#fff;width:100%;">Pilih</a> </td>
													</tr>
													<?php
