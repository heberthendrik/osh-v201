			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Lab - Tahap 2: Pilih Data Dokter Pengirim</h2>
							...
							<div class="col">
								<section class="card" style="margin-top:20px;">
									<header class="card-header" style="text-align:right;">
										<a href="add_1.php?id=<?php echo $_GET['id'];?>" class="btn btn-warning">Kembali ke Tahap 1</a>
									</header>
								</section>
							</div>
						</div>
							...
							<div class="tabs">
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular" data-toggle="tab">Internal</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent" data-toggle="tab"> Eksternal</a>
									</li>
								</ul>
										...
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												...
												for( $i=0;$i<$function_GetAllDokter['TOTAL_ROW'];$i++ ){
													...
													if( $function_GetAllDokter['IS_ACTIVE'][$i] == 1 ){
													...
													if( $function_GetAllDokter['ID'][$i] > 1 ){
														?>
														<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllDokter['ID'][$i] ;?>'">
															<td><?php echo $function_GetAllDokter['ID'][$i];?></td>
															<td><?php echo $function_GetAllDokter['NAME'][$i];?></td>
															<td><?php echo $function_GetAllDokter['NIK_EMPLOYEE'][$i];?></td>
															<td><?php echo $display_status;?></td>
															<td><?php echo $function_GetRumahSakitByID['NAMA'][0];?></td>
															<td> <a href="process.php?module=InputLabTahap2&isInternalDoctor=1&id=<?php echo $_GET['id'];?>&did=<?php echo $function_GetAllDokter['ID'][$i]; ?>" class="btn btn-danger" style="color:#fff;width:100%;">Pilih</a> </td>
														</tr>
														<?php	
													}
									...
									<div id="recent" class="tab-pane">
										<form action="process.php" method="get">
											<div class="form-group row">
												...
												<div class="col-lg-6">
													<input name="textDrPengirim" type="text" class="form-control" id="input_alamatdokter" value="<?php echo $function_GetLabMasterByID['DOCTOR_SENDER_NAME'][0];?>" >
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-6">
													<input name="textAlamatDokter" type="text" class="form-control" id="input_alamatdokter" value="<?php echo $function_GetLabMasterByID['DOCTOR_SENDER_ADDRESS'][0];?>" >
												</div>
											</div>
											<div class="form-group row">
											...
											<input type="hidden" name="module" value="InputLabTahap2" />
											<input type="hidden" name="isInternalDoctor" value="0" />
